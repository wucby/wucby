...
<body class="skin-blue">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<jsp:include page="../../menu.jsp" /> <!-- /.sidebar --> </aside>

		<!-- Right side column. Contains the navbar and content of the page -->
		<aside class="right-side"> <!-- Content Header (Page header) -->
		<section class="content-header">
		<h1>
			仓库管理 <small>仓库查询</small>
		</h1>
					...
					<div class="box-body table-responsive no-padding">
						<table class="table table-hover">
							...
							<c:forEach items="${data}" var="s">
								<tr>
									<td>${s.warehouseId }</td>
									<td>${s.warehourseName }</td>
									<td>${s.warehouseAddress }</td>
									<td>${s.warehouseManager }</td>
									<td><a
										href="deleteWarehouse.do?warehouseId=${s.warehouseId }"
										class="btn red icn-only"> 删除 </a></td>
								</tr>
							</c:forEach>
							<tr>
								<td></td>
								...
								<td><a class="btn btn-info btn-sm" href="Add_Warehouse.jsp">
										添加仓库 </a></td>
							</tr>
