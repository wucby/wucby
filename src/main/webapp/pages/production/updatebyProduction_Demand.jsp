...
<body class="skin-blue">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<h1>
			修改生产需求 <small>生产管理</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> 主页</a></li>
			<li><a href="#">生产管理</a></li>
			<li class="active">修改生产需求</li>
		</ol>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					...
					<form action="editProductionDemandInformation.do" method="post">
						<table class="table table-hover">
<thead>
							<tr>
								<td>产品编号</td>
								<td><div class="success"><input type="text" name="productId"
									value="${f.productId}" /><input type="hidden" name="DemandId"
												value="${f.demandId }" /></td>
							</tr>
							...
							<tr>
								...
								<td><div class="success"></div><input type="text" name="productCount"
									value="${f.productCount}" /></td>
							</tr>
							</thead>
							<tr>
								<td><a href="queryproductiondemand.do"
