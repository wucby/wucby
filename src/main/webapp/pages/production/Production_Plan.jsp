...
<body class="skin-blue">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<section class="content-header">
				<h1>
					生产计划表 <small>生产管理</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> 主页</a></li>
					<li><a href="#">生产管理</a></li>
					<li class="active">生产计划表</li>
				</ol>
			</section>
							...
							<div class="box-header">
								...
								<div class="box-tools">
									<div class="input-group">
										...
										<a href="uploadbyProduction_Plan.jsp"
											class="btn btn-sm btn-danger"> 添加 </a> <input type="text"
											name="table_search" class="form-control input-sm pull-right"
									...
									<table class="table table-hover">
										...
										<c:forEach items="${data }" var="s">
											<tr>
                                            	...
                                            	<c:if test="${s.checkStatus == 2}">
                                            		<button 
													class="btn btn-sm btn-success" onclick="updateCheckStatus('${s.planId }')"> 通过</button>
                                            		<button 
													class="btn btn-sm btn-info" onclick="updateCheckStatus2('${s.planId }')"> 不通过</button>
                                            	</c:if>
                                            	</td>


												<td>
												<c:if test="${s.completeStatus == 1 }">
                                            	
                                            		<button class="btn btn-sm btn-success"
															onclick="updatecompleteStatus('${s.planId }')">
															完成</button>
                                            	</c:if> 
                                            	<c:if test="${s.completeStatus == 0 }">
                                            	已完成
												...
												<td><a href="queryPlanId.do?planId=${s.planId }"
													class="btn btn-sm btn-info"> 修改</a> 
													<a
													href="downloadbyproductionplan.do?planId=${s.planId }"
													class="btn btn-sm btn-success"> 下载</a></td>
											</tr>
										</c:forEach>
	...
	<script src="ProductionPlan_js/updateCheckStatus.js"
		type="text/javascript"></script>
	<script src="ProductionPlan_js/updatecompleteStatus.js"
		type="text/javascript"></script>
</body>
</html>