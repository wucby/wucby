...
<!-- 	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			...
			<section class="content-header">-->
				<h1>
					生产需求表 <small>生产管理</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> 主页</a></li>
					<li><a href="#">生产管理</a></li>
					<li class="active">生产需求表</li>
				</ol>
			</section>
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">生产需求</h3>
								<div class="box-tools">
									<div class="input-group">

										<a href="uploadbyProduction_Demand.jsp" class="btn btn-sm btn-danger">
											添加 </a> <input type="text" name="table_search"
									...
									<table class="table table-hover">
										...
										<c:forEach items="${data }" var="s">
											<tr>
                                            	...
                                            	<c:if test="${s.checkStatus == 2}">
                                            		<button 
													class="btn btn-sm btn-success" onclick="updateCheckStatus('${s.demandId }')"> 通过</button>
                                            		<button 
													class="btn btn-sm btn-info" onclick="updateCheckStatus2('${s.demandId }')"> 不通过</button>
                                            	</c:if>
                                            	</td>
												
												<td>
												<a href="queryDemandId.do?demandId=${s.demandId }"
													class="btn btn-sm btn-info"> 修改</a><a
													href="downloadbyproductiondemand.do?demandId=${s.demandId }"
	...
	<script src="ProductionDemand_js/updateCheckStatus.js"
