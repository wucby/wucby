...
<body class="skin-blue">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<h1>
			提交生产需求 <small>生产管理</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> 主页</a></li>
			<li><a href="#">生产管理</a></li>
			<li class="active">提交生产需求</li>
		</ol>
							...
							说明：<br>
								...
								3，所有“已通过”的生产需求表，必须有原文档或图片资源。<br>
							</p>

						</blockquote>
<form id="fileupload" action="addproductiondemand.do" method="POST" enctype="multipart/form-data">
					...
					<div class="box-body table-responsive no-padding">
						...
						<table class="table table-hover">
							...
							<tr>
								...
								<td><a href="queryproductiondemand.do" class="btn btn-sm btn-danger"><i
