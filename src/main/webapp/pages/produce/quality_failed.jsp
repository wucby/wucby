...
<body onload="loadFaile(1)">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<h1>
			检验记录 <small>不合格检验记录</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> 主页</a></li>
			<li><a href="#">检验记录</a></li>
			<li class="active">不合格检验记录</li>
		</ol>
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">不合格检验记录信息</h3>
						<div class="box-tools">
					...
					<a class="btn btn-info btn-success" href="qualityfailed_add.jsp">
						添加记录 </a>
	...
	<!-- ./wrapper -->
	   ...
	   <!-- jQuery 2.0.2 -->
        <script src="../../js/jquery.min.js"></script>
        	<script type="text/javascript" src="../../biz/failed.js"></script> 
        <!-- Bootstrap -->
