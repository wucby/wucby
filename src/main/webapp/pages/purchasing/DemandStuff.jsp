...
//				拼接
				...
				//alert(data.listDatas[0].demandOrderId);
				for (var i = 0; i < data.listDatas.length; i++) {

					code += "<tr align='center'>";
					code += "<td>" + data.listDatas[i].demandOrderId + "</td>";
					code += "<td>" + data.listDatas[i].stuffId + "</td>";
					code += "<td>" + data.listDatas[i].stuffCount + "</td>";
					code += "<td><a href='createDemand.do?demandOrderId="+data.listDatas[i].demandOrderId+"'>添加采购需求</a></td>";
					code += "</tr>";
...
<body onload="sele2()" class="skin-blue">
					...
					<div class="box-header">
						...
						<div class="box-tools">
							<div class="input-group">
								<tr>
									<td><input type="text" name="table_search"
								...
								<div class="input-group-btn">
									<button class="btn btn-sm btn-default"><i class="fa fa-search">查询</i></button>								</div>
							</div>
						</div>
					</div>
					<!-- <div class="input-group">
						<a href="Purchase_Demand_Order_add.jsp"><button
								class="btn btn-sm btn-success">添加采购需求</button></a>
					</div> -->
					<!-- /.box-header -->
