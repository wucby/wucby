...
function add(demandOrderId){
	//alert("add");
	//alert(demandOrderId);
	
	var demandDate=$("#demandDate").val();
	var fillEmployee=$("#fillEmployee").val();
	$.post(
		"PurchaseDemandOrderadd.do",
		{"demandOrderId":demandOrderId,"demandDate":demandDate,"fillEmployee":fillEmployee},
		function (data){
			location.href="Purchase_Demand_Order.jsp";
...
<body class="skin-blue">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<section class="sidebar"> </section> <!-- /.sidebar --> </aside>
		<jsp:include page="../../menu.jsp"></jsp:include>
		<!-- Right side column. Contains the navbar and content of the page -->
		<aside class="right-side"> <!-- Content Header (Page header) -->
		<section class="content-header">
		<h1>
			采购需求管理 <small>添加采购需求</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> 主页</a></li>
			<li><a href="#"> 采购需求管理</a></li>
			<li class="active">添加采购需求</li>
		</ol>
				...
				<div class="box box-primary">
					...
					<!-- form start -->
						...
						<div class="box-body">
							...
							<div class="form-group">
								<div class="input-group">
									...
									<input id="demandDate" type="text" class="form-control"
										data-inputmask="'alias': 'yyyy-MM-dd HH:mm:ss'" data-mask />
								</div>
								<!-- /.input group -->
							</div>
							<!-- /.form group -->
							...
							<div class="input-group">
								<span class="input-group-addon">填单人</span> <input id="fillEmployee" type="text"
							...
							<div class="form-group">
								...
								<label>审核状态</label> <select id="checkStatus" class="form-control">
							...
							<div class="form-group">
								...
								<label>状态</label> <select id="demandStatus" class="form-control">
									<option value="1">未制定采购计划</option>
								</select>
							</div>
						</div>
						<!-- /.box-body -->
						...
						<div class="box-footer">
							<button onclick="add(${demandOrderId})" class="btn btn-primary">提交</button>
						</div>
		...
		</section> <!-- jQuery 2.0.2 --> <script src="../../js/jquery.min.js"></script> <!-- Bootstrap -->
		<script src="../../js/bootstrap.min.js" type="text/javascript"></script>
		<!-- AdminLTE App --> <script src="../../js/AdminLTE/app.js"
			type="text/javascript"></script>
			<script src="../../js/DemandStuff.js" type="text/javascript"></script>
</body>
