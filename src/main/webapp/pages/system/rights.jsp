...
<body class="skin-blue" onload="loadRightsdata()">
							...
							<div class="box-header">
								...
								<div class="box-tools">
									<div class="input-group">
										 <input id="rightsName" type="text"
											name="rightsName" class="form-control input-sm pull-right"
											style="width: 150px;" placeholder="请输入权限名.." />
	...
	<script type="text/javascript" src="../../biz/rights.js"></script>
</body>
</html>