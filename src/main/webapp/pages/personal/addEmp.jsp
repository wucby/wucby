                                ...
                                <div class="box-body table-responsive no-padding">
                                    <table class="table table-hover">
                                        <tr>
                                        	...
                                        	<td>
                                        		性别&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																		男<input type="radio"  id="gender" name="gender" value="1"  />
                                        								女<input type="radio"  id="gender" name="gender" value="0" />	
                                        	</td>
                                        </tr>	
                                        <tr>
                                        ...
                                        <tr>
                                        	...
                                        	<td>
                                        		部门&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id="departmentId" name="departmentId">
                                       ...
                                       <tr>
                                       		<td>
                                        	<button onclick="addEmp()" class="label label-danger btn-sm"  style="width:50px;height:25px;">提交</button>
                                       		</td>
                                        </tr>
